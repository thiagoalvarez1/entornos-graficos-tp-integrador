...
<head>
    ...
    <title>Panel de Cliente - PromoShopping</title>
    ...
    <style>
        ...
        .user-header {
            background: linear-gradient(rgba(46, 204, 113, 0.8), rgba(46, 204, 113, 0.8)), url('https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-4.0.3') center/cover;
            color: white;
            padding: 30px;
            border-radius: 10px;
            margin-bottom: 20px;
                ...
                <div class="d-flex align-items-center">
                    <div class="dropdown">
                        <a href="#" class="dropdown-toggle text-dark text-decoration-none" id="userDropdown" role="button" data-bs-toggle="dropdown">
                            <img src="https://ui-avatars.com/api/?name=Laura+Martinez&background=random" class="rounded-circle me-2" width="32" height="32">
                ...
                <div class="card-dashboard card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Promociones Usadas</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card-dashboard card border-left-success shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Ahorro Total</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card-dashboard card border-left-info shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Locales Visitados</div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card-dashboard card border-left-warning shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Para Premium</div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <div class="promo-card card h-100">
                                    ...
                                    <img src="https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?ixlib=rb-4.0.3" class="card-img-top" alt="Local 1" height="160" style="object-fit: cover;">
                                    <div class="card-body">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="promo-card card h-100">
                                    <span class="category-badge badge-inicial">Inicial</span>
                                    <img src="https://images.unsplash.com/photo-1605733513597-a8f8341084e6?ixlib=rb-4.0.3" class="card-img-top" alt="Local 2" height="160" style="object-fit: cover;">
                                    <div class="card-body">
                                        <h5 class="card-title">15% en accesorios</h5>
                                        <p class="card-text">En toda la sección de accesorios. Válido hasta el 25/08/2025.</p>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <small class="text-muted"><i class="fas fa-store me-1"></i> Fashion Store</small>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="promo-card card h-100">
                                    <span class="category-badge badge-inicial">Inicial</span>
                                    <img src="https://images.unsplash.com/photo-1593642632823-8f785ba67e45?ixlib=rb-4.0.3" class="card-img-top" alt="Local 3" height="160" style="object-fit: cover;">
                                    <div class="card-body">
                                        <h5 class="card-title">10% en segunda unidad</h5>
                                        <p class="card-text">En la segunda unidad de cualquier producto. Válido hasta el 20/09/2025.</p>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <small class="text-muted"><i class="fas fa-store me-1"></i> TechWorld</small>
                                            <small class="text-muted"><i class="fas fa-calendar me-1"></i> Fin de semana</small>
                                        </div>
                                    </div>
                                    <div class="card-footer bg-white">
                                        <a href="#" class="btn btn-primary w-100">Usar promoción</a>
                ...
                <div class="card-dashboard card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3 p-3 border rounded">
                            ...
                            <p class="small mb-0">Descubre las nuevas tendencias de verano en todos nuestros locales. No te quedes sin tu outfit perfecto para esta temporada.</p>
                        </div>
                        <div class="mb-3 p-3 border rounded">
                            <h6 class="font-weight-bold">Horario extendido</h6>
                            <p class="small text-muted">Publicado: 10/08/2025 • Para: Todos</p>
                            <p class="small mb-0">A partir de esta semana, extendemos nuestro horario hasta las 22hs. Vení a disfrutar de tus compras con más tiempo.</p>
                        </div>
                        <div class="p-3 border rounded">
                            <h6 class="font-weight-bold">Promociones de fin de mes</h6>
                            <p class="small text-muted">Publicado: 05/08/2025 • Para: Inicial</p>
                            <p class="small mb-0">Aprovecha las increíbles ofertas de fin de mes en todos los locales. Descuentos especiales para clientes iniciales.</p>
                        </div>
                    </div>
                </div>
            </div>
