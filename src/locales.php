...
<style>
    ...
    .page-header::before {
        ...
        right: 0;
        height: 6px;
        background: linear-gradient(90deg, var(--primary-purple), var(--secondary-purple), var(--accent-blue));
    ...
    .local-card:nth-child(5) {
        animation-delay: 0.5s;
    }

    .local-card:nth-child(6) {
